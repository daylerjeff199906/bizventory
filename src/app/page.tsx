...
import BannerSearchBar from '@/components/storefront/banner-search-bar'
...
export default async function Home({ searchParams }: Props) {
  ...
  return (
    <div className="min-h-screen bg-slate-50/50 flex flex-col font-sans">
      ...
      {/* Hero Banner Section */}
      <section className="w-full bg-slate-950 border-b border-rose-950/45 relative overflow-hidden py-16 sm:py-24 md:py-28 shadow-xl bg-[url('/images/banner_background.png')] bg-cover bg-center bg-no-repeat">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 flex flex-col gap-10">
          <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-8 w-full">
            ...
            <div className="w-full lg:w-auto shrink-0 bg-white/5 border border-white/10 p-6 rounded-2xl backdrop-blur-md flex flex-col items-center text-center shadow-lg min-w-[240px] text-white">
          ...
          {/* Inline search bar and view all at the bottom */}
          <div className="w-full pt-4 border-t border-white/5">
            <BannerSearchBar currentSearch={currentSearch} />
          </div>
        </div>
      </section>
